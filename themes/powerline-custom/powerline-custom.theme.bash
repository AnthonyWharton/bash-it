...
PROMPT_CHAR_ROOT=${POWERLINE_PROMPT_CHAR_ROOT:="#"}
...
USER_INFO_THEME_PROMPT_COLOR_SUDO=88
...
LAST_STATUS_THEME_PROMPT_COLOR=${USER_INFO_THEME_PROMPT_COLOR}
LAST_STATUS_THEME_PROMPT_COLOR_SUDO=${USER_INFO_THEME_PROMPT_COLOR_SUDO}
LAST_STATUS_THEME_ERR_COLOR=52
